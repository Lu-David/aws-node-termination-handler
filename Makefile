...
ECR_REGISTRY ?= public.ecr.aws/p2b8v2q4#TODO: 851725162668.dkr.ecr.us-east-1.amazonaws.com # public.ecr.aws/aws-ec2
...
release: build-binaries build-docker-images push-docker-images#TODO: generate-k8s-yaml upload-resources-to-github
