...
build-docker-images-windows-2019:
	${MAKEFILE_PATH}/scripts/build-docker-images -p "windows-10.0.17763.6189/amd64" -r ${IMG} -v ${VERSION}

build-docker-images-windows-2022:
	${MAKEFILE_PATH}/scripts/build-docker-images -p "windows-10.0.20348.2582/amd64" -r ${IMG} -v ${VERSION}
...
push-docker-images-windows-2019:
	${MAKEFILE_PATH}/scripts/retag-docker-images -p "windows-10.0.17763.6189/amd64" -v ${VERSION} -o ${IMG} -n ${ECR_REPO}
	bash ${MAKEFILE_PATH}/scripts/install-amazon-ecr-credential-helper $(AMAZON_ECR_CREDENTIAL_HELPER_VERSION)
	${MAKEFILE_PATH}/scripts/push-docker-images -p "windows-10.0.17763.6189/amd64" -r ${ECR_REPO} -v ${VERSION} -m

push-docker-images-windows-2022:
	${MAKEFILE_PATH}/scripts/retag-docker-images -p "windows-10.0.20348.2582/amd64" -v ${VERSION} -o ${IMG} -n ${ECR_REPO}
	bash ${MAKEFILE_PATH}/scripts/install-amazon-ecr-credential-helper $(AMAZON_ECR_CREDENTIAL_HELPER_VERSION)
	${MAKEFILE_PATH}/scripts/push-docker-images -p "windows-10.0.20348.2582/amd64" -r ${ECR_REPO} -v ${VERSION} -m
...
build-binaries-windows-2019:
	${MAKEFILE_PATH}/scripts/build-binaries -p "windows-10.0.17763.6189/amd64" -v ${VERSION}

build-binaries-windows-2022:
	${MAKEFILE_PATH}/scripts/build-binaries -p "windows-10.0.20348.2582/amd64" -v ${VERSION}
